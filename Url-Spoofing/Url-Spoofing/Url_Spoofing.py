    ...
    def window(self):
        def take_url():
            try:
                ...
                loaded.place(x = 130, y = 230)
            except:
                loaded.place(x = 5, y = 50)
                error.place(x = 130, y = 230)
        ...
        root = tkinter.Tk()
        root.title('Url-Spoofing - by Bl4ckV')
        root.iconbitmap(self.get_path('eye.ico'))
        root.geometry('350x350')
        root.configure(bg='black')
        root.resizable(False, False)

        loaded = tkinter.Label(root, text = '[ + ] Loaded url!', bg = 'black', fg = 'green', font = ('Arial', 10, 'bold'))
        error = tkinter.Label(root, text = '[ - ] Enter a valid url!', bg = 'black', fg = 'red', font = ('Arial', 10, 'bold'))
        text1 = tkinter.Label(root, text = 'Url:', font = ('Arial', 10, 'bold'), fg = 'red', bg = 'black')
        text1.place(x = 28, y = 120)
        text2 = tkinter.Label(root, text = 'Custom part:', font = ('Arial', 10, 'bold'), fg = 'red', bg = 'black')
        text2.place(x = 28, y = 170)
        text3 = tkinter.Label(root, text = 'New url:', font = ('Arial', 10, 'bold'), fg = 'red', bg = 'black')
        text3.place(x = 28, y = 270)

        title = tkinter.Label(root, text = 'URL', bg = 'black', font = ('Arial', 30, 'bold'), fg = 'white')
        title.place(x = 200, y = 30)
        title2 = tkinter.Label(root, text = 'Spoofing', bg = 'black', font = ('Arial', 20, 'bold'), fg = 'white')
        ...
        second_text = tkinter.Label(root, text = 'Second custom:', font = ('Arial', 10, 'bold'), fg = 'red', bg = 'black').place(x = 180, y = 170)
